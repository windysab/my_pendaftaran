                            ...
                            <div class="p-4 space-y-4">
                                <div class="relative w-full">
                                    ...
                                    <div id="lainnya_input" class="mt-2 hidden">
                                        <textarea name="detail_lainnya"
                                            class="textarea textarea-floating is-valid mt-1 block w-full border border-gray-300 focus:border-blue-500 bg-white"
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="relative w-full">
                                        <input type="number" id="kumpul_baik_selama_tahun" name="kumpul_baik_selama_tahun"
                                            class="input is-valid mt-1 block w-full border border-gray-300 focus:border-blue-500 bg-white text-black"
                                            placeholder="Tahun">
                                    ...
                                    <div class="relative w-full">
                                        <input type="number" id="kumpul_baik_selama_bulan" name="kumpul_baik_selama_bulan"
                                            class="input is-valid mt-1 block w-full border border-gray-300 focus:border-blue-500 bg-white text-black"
                                            placeholder="Bulan">
                                ...
                                @for ($i = 1; $i <= 10; $i++)
                                <div id="anak_{{ $i }}_fields" class="grid grid-cols-2 gap-4 hidden">
                                    <div class="relative w-full">
                                        <input type="text" id="anak_{{ $i }}" name="anak_{{ $i }}"
                                            class="input is-valid mt-1 block w-full border border-gray-300 focus:border-blue-500 bg-white text-black"
                                    ...
                                    <div class="relative w-full">
                                        <input type="date" id="tanggal_lahir_anak_{{ $i }}" name="tanggal_lahir_anak_{{ $i }}"
                                            class="input is-valid mt-1 block w-full border border-gray-300 focus:border-blue-500 bg-white text-black">
